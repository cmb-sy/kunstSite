  ...
  return (
    <div className="container mx-auto py-5 px-2 lg:px-10 flex justify-end w-full">
      <div className="flex flex-col w-full max-w-5xl">
        <div className="w-full lg:w-4/5 bg-white bg-gray-100 p-5 rounded-lg min-h-screen">
      ...
      <aside className="w-full lg:w-1/3 bg-gray-200 p-5 rounded-lg mt-5 lg:mt-0 lg:ml-20 hidden lg:block">
        <ProfileCard />
